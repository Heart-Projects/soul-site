...
export const useCreateEditor = (editorProps: SoulEditorProps) => {
  const { value = [], mode } = editorProps;
  const dynamicPlugins = [
    ...(mode === "edit" ? [FixedToolbarPlugin, FloatingToolbarPlugin] : []),
  ];
  return usePlateEditor({
    ...
    plugins: [...copilotPlugins, ...editorPlugins, ...dynamicPlugins],
    value,
  });
};
